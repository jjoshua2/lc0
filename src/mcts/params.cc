...
void SearchParams::Populate(OptionsParser* options) {
  ...
  options->Add<FloatOption>(kCpuctId, 0.0f, 100.0f) = 2.1f;
  ...
  options->Add<FloatOption>(kTradePenaltyId, -1.0f, 1.0f) = 0.0015f;
  options->Add<FloatOption>(kTradePenalty2Id, -1000.0f, 1000.0f) = 26.0f;
  ...
  options->Add<FloatOption>(kSmartPruningFactorId, 0.0f, 10.0f) = 1.4f;
  ...
  options->Add<IntOption>(kMaxOutOfOrderEvalsId, 1, 10000) = 512;
